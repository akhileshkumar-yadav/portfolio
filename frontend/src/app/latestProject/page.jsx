  ...
  return (
    <div ref={sectionRef} id="latest-project" className="container lg:h-[100vh] mt-15 text-white">
      ...
      <div className="md:flex mr-3 md:mr-1 flex-wrap justify-center items-center space-x-11 p-6">
        ...
        {/* SECOND CARD */}
        <div
          className="project-card lg:w-[430px] lg:h-[320px] h-[290px] mb-5 lg:mb-0 w-[350px] lg:ml-5 ml-5 md:ml-0 rounded-lg flex flex-col justify-center items-center relative overflow-hidden"
          style={{ boxShadow: "0px 4px 23px rgba(17, 50, 237, 3.1)" }}
        >
